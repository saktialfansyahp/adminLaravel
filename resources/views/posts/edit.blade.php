    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                <div class="mb-4">
                    <label for="textcover"
                        class="block mb-2 text-sm font-bold text-gray-700">Cover</label>
                    <input type="text"
                        class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        name="cover"
                        value="{{ $post->cover }}"
                        placeholder="Enter cover">
                    @error('cover') <span class="text-red-500">{{ $message }}
                    </span>@enderror
                </div>
                <div class="mb-4">
                    <label for="textterbit"
                ...
                <div class="mb-4">
                    <label for="textkategori_1"
                        class="block mb-2 text-sm font-bold text-gray-700">Kategori 1</label>
                    <input type="text"
                        class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        name="kategori_1"
                        value="{{ $post->kategori_1 }}"
                        placeholder="Enter kategori_1">
                    @error('kategori_1') <span class="text-red-500">{{ $message }}
                    </span>@enderror
                </div>
                <div class="mb-4">
                    <label for="textkategori_2"
                        class="block mb-2 text-sm font-bold text-gray-700">Kategori 2</label>
                    <input type="text"
                        class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        name="kategori_2"
                        value="{{ $post->kategori_2 }}"
                        placeholder="Enter kategori_2">
                    @error('kategori_2') <span class="text-red-500">{{ $message }}
                    </span>@enderror
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="textisi"
                        class="block mb-2 text-sm font-bold text-gray-700">Isi</label>
                    <input type="text"
                        class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        name="isi"
                        value="{{ $post->isi }}"
                        placeholder="Enter isi">
                    @error('isi') <span class="text-red-500">{{ $message }}
                    </span>@enderror
                </div>
                <div>
                    <button type="submit"
