                ...
                <a href="{{ route('posts.index') }}"
                    ...
                    <- Go back </a>
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                                <label for="textname" class="block mb-2 text-sm font-bold text-gray-700">Judul</label>
                                <input type="text"
                            ...
                            <div class="mb-4">
                                <label for="textname" class="block mb-2 text-sm font-bold text-gray-700">Tahun
                                    Terbit</label>
                                <input type="text"
                                    class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    name="terbit" placeholder="Enter terbit">
                                @error('terbit')
                                    <span class="text-red-500">{{ $message }}
                                    </span>
                                @enderror
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <label for="textname" class="block mb-2 text-sm font-bold text-gray-700">Kategori
                                    2</label>
                            ...
                            <div class="mb-4">
                                <label for="textname" class="block mb-2 text-sm font-bold text-gray-700">Rating</label>
                                <input type="text"
                                    class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                            ...
                            <div class="mb-4">
                                <div class="form-group">
                                    <strong>Isi :</strong>
                                    <input type="file" name="isi" class="form-control" accept="application/pdf"
                                        required>
                                    placeholder="isi format: pdf">
                                    @error('isi')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
